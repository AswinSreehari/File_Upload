...
export default function DocumentList({ documents, onSelect, selectedId }) {
  ...
  return (
    <div className="flex-1 rounded-2xl border border-slate-800/70 bg-slate-950/90 p-4 shadow-[0_18px_45px_rgba(15,23,42,0.65)] overflow-y-auto mt-2 backdrop-blur-lg">
